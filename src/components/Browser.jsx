...
const Browser = () => {
  return (
    <>
      ...
      <section className='flex justify-center flex-col lg:flex-row items-center gap-6 py-1 mt-4'>
        <input type="text" placeholder="Search your pokemon" className='bg-gray-200 border-gray-300 rounded-lg p-3 w-1/2 lg:flex-[.4] outline-none text-lg shadow-md' />
